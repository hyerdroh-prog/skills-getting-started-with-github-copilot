...
activities = {
    ...
    "Swimming Club": {
        "description": "Practice swimming techniques and compete in friendly meets",
        "schedule": "Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["noah@mergington.edu", "mia@mergington.edu"]
    },
    "Drama Club": {
        "description": "Explore acting, stagecraft, and perform school plays",
        "schedule": "Tuesdays, 3:45 PM - 5:15 PM",
        "max_participants": 25,
        "participants": ["isabella@mergington.edu", "lucas@mergington.edu"]
    },
    "Art Workshop": {
        "description": "Create artwork using painting, drawing, and mixed media",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
